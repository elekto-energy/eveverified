...
// (EVE-TPRM-00004556 / 00004561) — real data in data/syntheticAssessments.ts.
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-28 pb-16 w-full">
          <div className="max-w-2xl">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 border border-white/15 rounded-sm px-4 py-2.5 mb-4
            ...
            {/* Trust line — what the seal does and does not prove */}
            <p className="text-xs text-gray-500 leading-relaxed max-w-xl mb-10">
              The seal proves the workpaper has not changed after sealing. It does
              not prove that the assessment is correct.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="border-l-2 border-amber-500/40 pl-6">
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              EVE does not certify compliance. EVE does not approve vendors. EVE
              does not assess materiality. EVE verifies evidence support and
