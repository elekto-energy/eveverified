...
export default function EVECore() {
  ...
  const [hoveredTier1, setHoveredTier1] = useState<string | null>(null)
          ...
          {tier1Agents.map(agent => (
            <div 
              ...
              onMouseEnter={() => {
                ...
                setHoveredTier1(agent.id)
              }}
              onMouseLeave={() => {
                const timeout = setTimeout(() => setHoveredTier1(null), 400)
            ...
            >
              ...
              {/* Tier 2 children - hidden by default, shown on hover */}
              {agent.children.length > 0 && (
                <AnimatePresence>
                  {hoveredTier1 === agent.id && (
                    <motion.div
